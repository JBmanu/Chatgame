...
class LoginApplication(tk.Tk):
    ...
    def __init__(self):
        ...
        self.login_head_label = tk.Label(self, bg = Utils.BG_COLOR, fg = Utils.TEXT_COLOR,
                                 text = "Inserisci le credenziali richieste per accedere:", font = Utils.FONT_BOLD, pady = 1)
        ...
        self.ip_label = tk.Label(self, bg = Utils.BG_COLOR, fg = Utils.TEXT_COLOR, 
                         text = "HOST:", font = Utils.FONT_BOLD, padx = 1, pady = 10)
        ...
        self.port_label = tk.Label(self, bg = Utils.BG_COLOR, fg = Utils.TEXT_COLOR,
                           text = "PORT:", font = Utils.FONT_BOLD, padx = 1, pady = 10)
        ...
        self.nick_label = tk.Label(self, bg = Utils.BG_COLOR, fg = Utils.TEXT_COLOR,
                           text = "Nickname:", font = Utils.FONT_BOLD, padx = 1, pady = 10)
        ...
        #pulsante login
        self.pulsante_login = tk.Button(self.pulsante_login_label, text = "Login", font = Utils.FONT_BUTTON, width = 5, bg = Utils.BUTTON_COLOR)
        self.pulsante_login.place(relx = 0.39, relheight = 1, relwidth = 0.22)

        #box inserimento testo HOST
        self.host_entry  =  tk.Entry(self.ip_label_fianco, bg = "#2C3E50", fg = Utils.TEXT_COLOR, font = Utils.FONT)
        self.host_entry.place(relwidth = 1, relheight = 1, rely = 0.008, relx = 0.011)
        self.host_entry.focus()
        
        
         #box inserimento testo PORT
        self.port_entry  =  tk.Entry(self.port_label_fianco, bg = "#2C3E50", fg = Utils.TEXT_COLOR, font = Utils.FONT)
        self.port_entry.place(relwidth = 1, relheight = 1, rely = 0.008, relx = 0.011)
        self.port_entry.focus()
     
        #box inserimento testo NICK
        self.nick_entry  =  tk.Entry(self.nick_label_fianco, bg = "#2C3E50", fg = Utils.TEXT_COLOR, font = Utils.FONT)
